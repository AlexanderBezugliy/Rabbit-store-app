        ...
        <>
            <nav className='container mx-auto flex items-center justify-between py-4 px-6'>
                ...
                <div className='hidden md:flex space-x-6'>
                    ...
                    <Link to='/collections/botom-wear' className='text-gray-700 hover:text-black text-sm font-medium uppercase'>
                        Botom Wear
                    </Link> */}
                </div>
                ...
                <div className='flex items-center space-x-4'>
                    ...
                    >
                        ...
                        <span className='absolute -top-1 bg-rabbit-red text-white text-sm rounded-full px-2 py-0.5'>4</span>
                    </button>
            ...
            {/* MODAL Basket */}
            <CartBasket basketOpen={basketOpen} toggleCartBasket={toggleCartBasket} />
